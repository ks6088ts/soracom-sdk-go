...
func (r ApiGetVirtualPrivateGatewayRequest) Execute() (*VirtualPrivateGateway, *http.Response, error) {
...
// Execute executes the request
//  @return VirtualPrivateGateway
func (a *VirtualPrivateGatewayApiService) GetVirtualPrivateGatewayExecute(r ApiGetVirtualPrivateGatewayRequest) (*VirtualPrivateGateway, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
