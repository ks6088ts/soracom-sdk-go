...
func (o *Placement) GetInfrastructureProvider() string {
	if o == nil || o.InfrastructureProvider == nil {
		var ret string
		return ret
	}
	return *o.InfrastructureProvider
}

// GetInfrastructureProviderOk returns a tuple with the InfrastructureProvider field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Placement) GetInfrastructureProviderOk() (*string, bool) {
	if o == nil || o.InfrastructureProvider == nil {
		return nil, false
	}
	return o.InfrastructureProvider, true
}
...
func (o Placement) MarshalJSON() ([]byte, error) {
	...
	if o.InfrastructureProvider != nil {
		toSerialize["infrastructureProvider"] = o.InfrastructureProvider
	}
	if o.Region != nil {
