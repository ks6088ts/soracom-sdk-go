...
func (o *EstimatedOrderItemModel) GetTaxIncludedProductAmount() float32 {
	if o == nil || o.TaxIncludedProductAmount == nil {
		var ret float32
		return ret
	}
	return *o.TaxIncludedProductAmount
}

// GetTaxIncludedProductAmountOk returns a tuple with the TaxIncludedProductAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EstimatedOrderItemModel) GetTaxIncludedProductAmountOk() (*float32, bool) {
	if o == nil || o.TaxIncludedProductAmount == nil {
		return nil, false
	}
	return o.TaxIncludedProductAmount, true
}
...
func (o EstimatedOrderItemModel) MarshalJSON() ([]byte, error) {
	...
	if o.TaxIncludedProductAmount != nil {
		toSerialize["taxIncludedProductAmount"] = o.TaxIncludedProductAmount
	}
